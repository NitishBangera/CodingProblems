...
public class DoNotChangeTest {
    ...
    private void validateInterfaceWeatherCollector() {
        ...
        //
    	// Used Spring's ResponseEntity instead of javax rs Response
        ResponseEntity<?> pingResp = collector.ping();

        ResponseEntity<?> updateWeatherResp = collector.updateWeather((String) null, (String) null, (String) null);

        ResponseEntity<?> getAirportsResp = collector.getAirports();

        ResponseEntity<?> getAirportResp = collector.getAirport((String) null);

        ResponseEntity<?> addAirportResp = collector.addAirport((String) null, (String) null, (String) null);

        ResponseEntity<?> deleteAirportResp = collector.deleteAirport((String) null);
    }
    ...
    private void validateInterfaceWeatherQueryEndpoint() {
        ...
        //
    	// Used Spring's ResponseEntity instead of javax rs Response
    	ResponseEntity<?> pingResp = queryEndpoint.ping();

    	ResponseEntity<?> getResp = queryEndpoint.weather((String) null, (String) null);
    }
